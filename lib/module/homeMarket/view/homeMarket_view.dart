...
import '../controller/homeMarket_controller.dart';

import 'package:get/get.dart';

class HomeMarketView extends StatelessWidget {
  const HomeMarketView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<HomeMarketController>(
      init: HomeMarketController(),
      builder: (controller) {
